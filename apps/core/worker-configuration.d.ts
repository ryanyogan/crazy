/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8edc8dc69c10c4df43dd102d8e32abde)
...
interface __BaseEnv_Env {
	...
	BRIEF: Workflow<Parameters<import("./src/index").BriefWorkflow['run']>[0]['payload']>;
	INVOICE: Workflow<Parameters<import("./src/index").InvoiceWorkflow['run']>[0]['payload']>;
	ARCHIVE: Workflow<Parameters<import("./src/index").ArchiveWorkflow['run']>[0]['payload']>;
}
